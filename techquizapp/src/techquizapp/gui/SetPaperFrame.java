...
public class SetPaperFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcQuestionNumber = new javax.swing.JComboBox<>();
        ...
        jLabel5.setText("Chosse The  Subject");
        ...
        jcQuestionNumber.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jcQuestionNumber.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2", "3", "4", "5", "6", "7", "8", "9" }));
        jcQuestionNumber.setBorder(null);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(10, 10, 10)
                                        .addComponent(jcQuestionNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jLabel6)))
                .addGap(18, 18, 18)
                .addComponent(jcQuestionNumber, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnSetQuestion)
                    .addComponent(btnBack))
    ...
    private void btnSetQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetQuestionActionPerformed
       ...
       int questionNumber=Integer.parseInt(jcQuestionNumber.getSelectedItem().toString());
      int ans;
      ans=JOptionPane.showConfirmDialog(null, "You have Selected "+language+" and total questions "+questionNumber+"\n Is it OK?","Confirmation",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
      if(ans==JOptionPane.YES_OPTION){
      try{
          String examId=ExamDAO.getExamId();
          Exam exam=new Exam(examId,language,questionNumber);
          SetQuestionFrame questionFrame=new SetQuestionFrame(exam);
    ...
    private javax.swing.JComboBox<String> jcQuestionNumber;
